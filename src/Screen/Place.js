    ...
    <Row className="mt-5">
      <Col className="mt-5">
        ...
        <Row className="mb-5 txt-left txt-middle">
          <Col className="mb-5">
            <p className="mb-3 txt-bold">더컨벤션 신사</p>
            <p className="mb-5">Tel. 02-6081-5000</p>
            <p className="mb-3 txt-bold">지하철 이용 시</p>
            <p className="mb-5">3호선(신사역) 6번 출구에서 300M 도보 5분</p>
            <p className="mb-3 txt-bold">버스 이용 시</p>
            <p className="mb-5">
              40, 4312, 9404, 6009, 145, 148, 441, 542, 4212, 3030, 강남08,
              서초03
            </p>
            <p className="mb-3 txt-bold">자가용 이용시</p>
